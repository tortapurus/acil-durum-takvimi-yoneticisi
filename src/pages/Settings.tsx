...
const Settings: React.FC = () => {
  ...
  const [warningThreshold, setWarningThreshold] = React.useState(settings.warningThreshold.toString());
  const [reminderDays, setReminderDays] = React.useState(settings.reminderDays.toString());
  const [notificationsEnabled, setNotificationsEnabled] = React.useState(settings.notificationsEnabled);
  
  const [warningThresholdError, setWarningThresholdError] = React.useState("");
  const [reminderDaysError, setReminderDaysError] = React.useState("");
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Bildirim tercihleri ve zamanlama ayarları
          </CardDescription>
        </CardHeader>
